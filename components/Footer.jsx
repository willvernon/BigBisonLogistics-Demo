				...
				<div className="p-5 ">
					<ul>
						...
						<p className="text-btext text-sm font-semibold">
							Big Bison exists to solve complex problems. We believe some
							of the most difficult problems in an individuals life occur
							when they become prominent or successful.
						</p>
				...
				<div className="p-5">
					<ul>
						...
						<p className="text-btext text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
							More than just a quick saying, but one of the driving
							forces behind our success.
						</p>
						<p className="text-btext text-md pb-2 font-semibold hover:text-blue-600 cursor-pointer">
							<i>Always Adapting</i> signifies our pledge to stay
							vigilant to change. Chosing the path of greater success
							over relative ease.
						</p>
					</ul>
				</div>
